...
* `WOF Word Guessing_Publish.R` = Code for [this Shiny app](https://ktebbe.shinyapps.io/wof-words/) that helps you guess incomplete, popular words
* `WOF_analysis.Rmd` = Code for all the analysis that was done, including facts for flashcards, creating wallpapers, and calculating bonus round prize distibutions
